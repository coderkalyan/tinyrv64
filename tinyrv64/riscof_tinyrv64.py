...
class tinyrv64(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","tinyrv64")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for tinyrv64 start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
